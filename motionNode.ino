// motionNode
// New version of the Room Node derived from roomNode.ino (derived from rooms.pde).
// 10/02/2015 This is a motion and light only version of JCW's roomNode sketch.
...
static void doMeasure() {
    byte firstTime = 0; // payload.humi == 0; // special case to init running avg
